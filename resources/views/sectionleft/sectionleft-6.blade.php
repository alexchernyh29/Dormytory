...
@section('content')
    <div class="section-1">
        <div class="section-swap">
            ...
            <a href="/sectionleft-3" class="section-level">5 этаж</a>
            <a href="/sectionleft-4" class="section-level">6 этаж</a>
            <a href="/sectionleft-5" class="section-level">7 этаж</a>
            <a href="/sectionleft-6" class="section-level">8 этаж</a>
        </div>
    </div>
    <div class="section-level-7">
        <div class="levelup">
